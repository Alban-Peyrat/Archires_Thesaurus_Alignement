...
class Term(object):
    def __init__(self, id:str, label:str, extended_words:List[str]):
        ...
        self.forms[Step.FINGERPRINT_NO_PARENTHESIS] = fingerprint(self.label, no_parenthesis=True, reorder=True)
        self.forms[Step.FINGERPRINT_NO_PARENTHESIS_STOP_WORDS] = fingerprint(self.label, stop_words=True, no_parenthesis=True, reorder=True)
        self.forms[Step.FINGERPRINT_NO_PARENTHESIS_STOP_WORDS_EXTENDED] = fingerprint(self.label, stop_words=True, stop_words_extended=extended_words, no_parenthesis=True, reorder=True)
